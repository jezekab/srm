...
class StakeholdersControllerTest < ActionController::TestCase
  ...
  test "should create stakeholder" do
    assert_difference('Stakeholder.count') do
      post :create, stakeholder: { department: @stakeholder.department, relation: @stakeholder.relation, workplace: @stakeholder.workplace }
    end
  ...
  test "should update stakeholder" do
    patch :update, id: @stakeholder, stakeholder: { department: @stakeholder.department, relation: @stakeholder.relation, workplace: @stakeholder.workplace }
    assert_redirected_to stakeholder_path(assigns(:stakeholder))
  end
