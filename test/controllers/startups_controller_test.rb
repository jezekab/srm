...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { contact_id: @startup.contact_id, founded_date: @startup.founded_date, name: @startup.name, stage: @startup.stage, type: @startup.type }
    end
  ...
  test "should update startup" do
    patch :update, id: @startup, startup: { contact_id: @startup.contact_id, founded_date: @startup.founded_date, name: @startup.name, stage: @startup.stage, type: @startup.type }
    assert_redirected_to startup_path(assigns(:startup))
  end
